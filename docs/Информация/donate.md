...
!!! note ""
    ...
    === "Котик+"
        ...
        Кит - 1 АР, 16 золотой моркови, 4 золотых яблока, кофе, фейрверки, тортик :3
    ...
    === "Котик++"
        ...
        Кит: 2 Ар, 32 золотой моркови, кофе, фейрверки, 4 золотых яблока, тортик :3
    ...
    === "Котик+++"
        ...
        Кит: 2 Ар, 32 золотой моркови, 6 золотых яблочек, кофе, фейрверки, тортик :3
