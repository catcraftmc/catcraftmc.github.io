...
На пост **ГКСБ** был временно назначен **DasGoose**! Также в тюрьму были посажены **O4apoBaTeJlb** и **KonoMeq** на 50 дней.
...
В этот же день **DasGoose** закрывает набор в кадеты КСБ. Кадетами стали **TERKAAA**, **sqrefo_ru**, **assassin128** и **Slivki_lenivki**.
...
Довольно крупная обновление сервера:
